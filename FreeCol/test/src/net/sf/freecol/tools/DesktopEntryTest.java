...
/**
 * The class <code>DesktopEntryTest</code> contains tests for the class <code>{@link DesktopEntry}</code>.
 *
...
public class DesktopEntryTest {
	/**
	 * Run the DesktopEntry() constructor test.
	 *
	 * @generatedBy CodePro at 5/10/16 11:07 AM
	 */
	@Test
	public void testDesktopEntry_1()
		throws Exception {
		DesktopEntry result = new DesktopEntry();
