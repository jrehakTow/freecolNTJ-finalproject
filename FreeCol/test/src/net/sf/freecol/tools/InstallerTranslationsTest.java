...
/**
 * The class <code>InstallerTranslationsTest</code> contains tests for the class <code>{@link InstallerTranslations}</code>.
 *
 * @generatedBy CodePro at 5/10/16 11:07 AM
 * @author newsha
 * @version $Revision: 1.0 $
 */
public class InstallerTranslationsTest {
	/**
	 * Run the InstallerTranslations() constructor test.
	 *
	 * @generatedBy CodePro at 5/10/16 11:07 AM
	 */
	@Test
	public void testInstallerTranslations_1()
		throws Exception {
		InstallerTranslations result = new InstallerTranslations();
	...
	public void testMain_1()
		...
		InstallerTranslations.main(args);
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(InstallerTranslationsTest.class);
	}
}