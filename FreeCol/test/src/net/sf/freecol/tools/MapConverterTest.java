...
/**
 * The class <code>MapConverterTest</code> contains tests for the class <code>{@link MapConverter}</code>.
 *
...
public class MapConverterTest {
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(MapConverterTest.class);
	}
}